...
Esta etapa agrega cuatro módulos a los tres existentes. Mercado Libre y el sitio web permanecen al final. La instalación requiere Odoo 19 Community en el servidor Windows y los permisos de Compras, Inventario y Contabilidad para las tareas correspondientes.
...
Los movimientos manuales que alteran saldo (emisión fuera del POS, cancelación, ajuste) permiten preparar un asiento en borrador. Necesitan que selecciones en la compañía un diario general y una cuenta de contrapartida exclusivos para estos ajustes: revisa la cuenta, motivo y fecha antes de publicarlo. Reponer un código no altera el saldo total ni genera otro asiento. Los movimientos provenientes del POS no generan un segundo asiento manual.
...
Conexión automática a estados de cuenta de proveedores y conciliación bancaria contable; perfil fiscal y cálculo revisable de IVA/ISR; editor del ticket; diseño del POS; compatibilidad de refacciones; Mercado Libre y web al final.
...
## Control de terminales: Mercado Pago, Stori y otros

Instala también `leyka_payment_control`. En Leyka Operación → Terminales: cobros y depósitos crea una revisión por liquidación y método POS. Captura su referencia, rango de fechas de cobro, zona horaria y fecha del depósito. «Agregar cobros del POS» reúne los cobros pagados que aún no están en otra liquidación. Los vales se excluyen. No se consultan servicios externos.

Copia la comisión real (base e impuestos) y el depósito recibido del estado de cuenta. Registra otros ajustes con signo y explicación. El cálculo es cobros netos − comisión total + otros ajustes. Solo se confirma la revisión si coincide con el depósito recibido. Puedes relacionar un movimiento bancario ya existente y la factura de comisión como referencia; no se genera una segunda factura de comisión ni un asiento automático. La revisión operativa no sustituye la conciliación contable de Odoo.

Stori se registra de esta manera manual. Mercado Pago usa el mismo control con los cobros que tu integración existente ya guardó en el POS. Cada pago solo se incluye en una liquidación. Para corregir una revisión, reábrela; para cambiar el periodo o método, libera primero sus cobros.
